    ...
    <div class="h-fit">
        <div class="h-fit py-10 flex flex-col justify-center items-center">
            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data" class="w-fit h-2/4 mx-auto pt-10 grid grid-cols-2 gap-3">
                ...
                <textarea name="paragraph1" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-2</label>
                <textarea name="paragraph2" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-3</label>
                <textarea name="paragraph3" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-4</label>
                <textarea name="paragraph4" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-5</label>
                <textarea name="paragraph5" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-6</label>
                <textarea name="paragraph6" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-7</label>
                <textarea name="paragraph7" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-8</label>
                <textarea name="paragraph8" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-9</label>
                <textarea name="paragraph9" placeholder="Description" class="rounded-md px-2"></textarea>
                <label class="text-white text-xl">Paragraph-10</label>
                <textarea name="paragraph10" placeholder="Description" class="rounded-md px-2"></textarea>
