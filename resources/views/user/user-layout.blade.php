...
<body>
    @yield('user-layout')
    <div class="h-screen sm:h-[60vh] bg-black relative">
        <div
            class="flex flex-col sm:flex-row gap-5 h-fit sm:h-3/4 bg-gradient-to-b from-purple-950 to-purple-950/55 w-11/12 left-0 right-0 m-auto rounded-md absolute bottom-5 px-2 md:px-5 lg:px-10 py-5">
            ...
            <div class="grid grid-cols-2 gap-3 sm:gap-0 sm:grid-rows-2 sm:grid-flow-col">
                <div class="sm:mr-8">
            ...
            <div>
                ...
                <iframe
                    ...
                    referrerpolicy="no-referrer-when-downgrade" class="hidden sm:block"></iframe>
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d253866.3154296647!2d107.290844!3d-6.176093!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e697fdf0cdd47ef%3A0x401576d14fed990!2sRengasdengklok%2C%20Karawang%2C%20West%20Java!5e0!3m2!1sen!2sid!4v1730686109680!5m2!1sen!2sid"
                    width="250" height="200" style="border:0;" allowfullscreen="" loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade" class="sm:hidden mx-auto"></iframe>
            </div>
        </div>
    </div>
</body>
