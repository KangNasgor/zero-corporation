    ...
    <div class="h-screen">
        <div class="flex gap-10 w-10/12 mx-auto justify-center mb-36">
            ...
            <div class="w-6/12">
                ...
                <p class="text-white w-8/12 mb-5" data-aos="fade-up">We started this company because we think technologies
                    need
                    to
                    be more common among everyone, therefore we give our customers the best option in technologies to be
                    used easily.
                </p>
                <p class="text-white w-8/12" data-aos="fade-up">We launch ZERO corp at late 2024 as a company that serves
    ...
    <div class="h-screen">
        <div class="flex gap-3 w-10/12 mx-auto justify-center">
            <div class="w-5/12">
                ...
                <p class="text-white w-9/12" data-aos="fade-up">We want to make more people understand and utilize
        ...
        <div class="w-10/12 mx-auto flex gap-5 justify-center mb-10">
            <div class="w-fit flex flex-col items-center">
                <img src="{{ asset('assets/guts.jpg') }}" width="120" height="120" class="rounded-full"
                    data-aos="fade-up">
                <h1 class="text-lg text-white w-fit" data-aos="fade-up">Guts</h1>
            ...
            <div class="w-fit flex flex-col items-center">
                <img src="{{ asset('assets/altair.jpg') }}" width="120" height="120" class="rounded-full"
                    data-aos="fade-up">
                <h1 class="text-lg text-white w-fit" data-aos="fade-up">Altaïr Ibn-LaʼAhad</h1>
            ...
            <div class="w-fit flex flex-col items-center">
                <img src="{{ asset('assets/aeri.jpg') }}" width="120" height="120" class="rounded-full aspect-square"
                    data-aos="fade-up">
                <h1 class="text-lg text-white w-fit" data-aos="fade-up">Uchinaga Aeri</h1>
            ...
            <div class="w-fit flex flex-col items-center">
                <img src="{{ asset('assets/ningning.jpg') }}" width="120" height="120" class="rounded-full"
                    data-aos="fade-up">
                <h1 class="text-lg text-white w-fit" data-aos="fade-up">Ning Yizhuo</h1>
