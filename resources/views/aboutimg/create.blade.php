@extends('./../layout')
@section('layout')
    <title>Create AboutIMG</title>
    <div>
        <div class="h-screen flex justify-center items-center">
            <form action="{{ route('aboutimg.store') }}" method="POST" enctype="multipart/form-data" class="w-fit h-2/4 mx-auto pt-10 grid grid-cols-2 gap-3">
                @csrf
                ...
                <input name="role" placeholder="Role" required class="rounded-md px-2 pt-2"></input>
