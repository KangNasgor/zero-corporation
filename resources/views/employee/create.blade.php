...
@section('layout')
    ...
    <div>
        <div class="h-screen flex flex-col justify-center items-center">
            <form action="/employee/create/store" method="POST" class="w-fit h-2/4 mx-auto pt-10 grid grid-cols-2 gap-3">
                @csrf
                <label class="text-white text-xl">Name</label>
                <input name="name" type="text" placeholder="Paul Johnson" required class="rounded-md p-2">
                <label class="text-white text-xl">Age</label>
                <input name="age" type="number" placeholder="99" required class="rounded-md p-2">
                <label class="text-white text-xl">Salary</label>
                <input name="salary" type="number" placeholder="1500000" required class="rounded-md p-2">
